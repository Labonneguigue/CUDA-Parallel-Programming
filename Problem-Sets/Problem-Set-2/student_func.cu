                        ...
                        const int filterWidth)
{
  ...
  cudaMemcpy(d_red, d_redBlurred, sizeof(unsigned char) * numRows * numCols, cudaMemcpyDeviceToDevice);
  cudaMemcpy(d_green, d_greenBlurred, sizeof(unsigned char) * numRows * numCols, cudaMemcpyDeviceToDevice);
  cudaMemcpy(d_blue, d_blueBlurred, sizeof(unsigned char) * numRows * numCols, cudaMemcpyDeviceToDevice);
